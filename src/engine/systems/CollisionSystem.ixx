...
public:
    void update(Ecs::EntityManager& manager, float deltaTime_s) override
    {
        ...
        Ecs::ComponentsForEachFn<Component::BoxCollision, Component::TransformComponent,
                                 Component::PlayerComponent> const forEachPlayerCollision{
            [&manager, &deltaTime_s](Ecs::Entity entityA, Component::BoxCollision& boxA,
                                     Component::TransformComponent& transformA, Component::PlayerComponent& player) {
