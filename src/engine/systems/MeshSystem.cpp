...
namespace System
{
void MeshSystem::update(Ecs::EntityManager& manager, float deltaTime_s)
{
    ...
    Ecs::ComponentsForEachFn<Component::ModelComponent, Component::TransformComponent> const forEachModel{
        [&view, &projection, &ambientLightColor, &pointLightPos, &pointLightColor, &camPos, &pointLightSpecularStength](
            Ecs::Entity entity, Component::ModelComponent& modelComponent, Component::TransformComponent& transform) {
            ...
            Graphics::ForEachMeshFn const forEachMesh{[&view, &projection, &ambientLightColor, &pointLightPos,
                ...
                mesh.shader->setUniform3f("u_pointLightColor", pointLightColor.x, pointLightColor.y, pointLightColor.z);
