...
namespace System
{
void PlayerSystem::update(Ecs::EntityManager& manager, float deltaTime_s)
{
    Ecs::ComponentsForEachFn<Component::PlayerComponent, Component::TransformComponent, Component::MovementComponent,
                             Component::InputComponent, Component::CameraComponent, Component::BoxCollision> const
        forEachPlayer{[](Ecs::Entity entity, Component::PlayerComponent& player,
...
void PlayerSystem::movePlayer(Component::MovementComponent& move, Component::CameraComponent const& cam,
