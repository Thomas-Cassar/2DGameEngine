...
void CameraSystem::update(Ecs::EntityManager& manager, float deltaTime_s)
{
    Ecs::ComponentsForEachFn<Component::CameraComponent, Component::TransformComponent, Component::InputComponent> const
        forEachCamera{[&deltaTime_s](Ecs::Entity entity, Component::CameraComponent& camera,
